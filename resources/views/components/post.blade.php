@foreach ($posts as $post)
    ...
    <div class="p-8 mb-8 bg-white shadow-md">
        ...
        <p class="text-zinc-600">{{$post->email}}</p>
        <p class="text-zinc-600">{{$post->address}}</p>
        <p class="text-zinc-600">{{$post->phone_number}}</p>
        <p class="text-zinc-600">{{$post->updated_at}}</p>
